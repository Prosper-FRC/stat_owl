...
function addRow(data = {}) {
    ...
    tr.innerHTML = `
        ...
        <td> <select> <option value="rect-1" ${isSel('rect-1', data.layout || 'rect-1')}>1x Rectangle</option> <option value="rect-2" ${isSel('rect-2', data.layout)}>2x Rect (Half)</option> <option value="circle-2" ${isSel('circle-2', data.layout)}>2x Circle (Half)</option> <option value="square-1" ${isSel('square-1', data.layout)}>1x Square (Tall)</option> <option value="rect-full" ${isSel('rect-full', data.layout)}>Full Rect Group</option> <option value="circle-full" ${isSel('circle-full', data.layout)}>Full Circle Group</option> <option value="rect-3" ${isSel('rect-3', data.layout || 'rect-3')}>3x Rectangle</option> </select> </td>
